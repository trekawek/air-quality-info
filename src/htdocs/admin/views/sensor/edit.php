        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo l('device', 'edit', null, array('device_id' => $deviceId)) ?>" method="post">
                    ...
                    <div class="form-group collapse map-control map-group <?php echo $device['location_provided'] ? 'show' : '' ?>" data-input-lat="#latInput" data-input-lng="#lngInput" data-input-elevation="#elevationInput" data-readonly="true">
                        <div class="map"></div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                    <?php foreach($sensorIds as $id): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($id) ?></td>
                            <td>
                                <a href="<?php echo l('sensor', 'deleteSensorId', null, array('device_id' => $deviceId, 'sensor_id' => $id)) ?>" class="btn btn-danger delete-link"><i class="fa fa-trash-o "></i></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php endforeach ?>
