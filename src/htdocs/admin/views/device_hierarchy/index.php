    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo l('device_hierarchy', 'move', null, array('node_id' => $d['id'])) ?>" method="post">
                                    ...
                                    <a href="<?php echo l('device_hierarchy', 'edit', null, array('node_id' => $d['id'])) ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                ...
                <a href="<?php echo l('device_hierarchy', 'createDir', null, array('node_id' => $nodeId)) ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
</div>