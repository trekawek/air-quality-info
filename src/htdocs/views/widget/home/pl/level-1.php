      ...
      <div class="col-md-6">
        ...
        <ul class="list-group">
          <li class="list-group-item text-center">
            <h3 class="">Jakość powietrza</h3>
          </li>

          <li class="list-group-item text-center">
            <i class="fa fa-meh-o fa-5x air-quality-1"></i>
            <h3 class="air-quality-1">Umiarkowana</h3>
          </li>
        </ul>

      </div>
      <?php include ("views/widget/home/weather.php"); ?>
    </div>
          ...
          <li class="list-group-item text-center">
            <span class="strip"><i class="icon-elderly orange"></i>
              <span class="strip-recommended">
                ...
                <br />
                <span class="strip-recommended-description">przebywanie na świeżym powietrzu (ciąża, astma, osoby
                  starsze)</span>
              </span>
            </span>
          </li>
